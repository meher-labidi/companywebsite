...
def bms_service(request):
    ...
    partners = [
        {
            'name': 'LOYTEC Electronics',
            'logo': 'fas fa-microchip',
            'description': 'Leading provider of building automation and control solutions',
            'products': ['LIOB-589', 'L-DALI', 'L-ROC', 'L-WEB']
        },
        {
            'name': 'Siemens',
            'logo': 'fas fa-industry',
            'description': 'Comprehensive building management solutions',
            'products': ['Desigo CC', 'Siemens PXC', 'Siemens PXG']
        },
        {
            'name': 'Honeywell',
            'logo': 'fas fa-building',
            'description': 'Enterprise building management systems',
            'products': ['Enterprise Buildings Integrator', 'Niagara Framework']
        },
        {
            'name': 'Schneider Electric',
            'logo': 'fas fa-bolt',
            'description': 'EcoStruxure Building solutions',
            'products': ['EcoStruxure', 'SmartStruxure', 'StruxureWare']
        }
    ]
    ...
    bms_features = [
        {
            'title': 'HVAC Control',
            'icon': 'fas fa-wind',
            'description': 'Intelligent heating, ventilation, and air conditioning control'
        },
        {
            'title': 'Lighting Management',
            'icon': 'fas fa-lightbulb',
            'description': 'DALI and smart lighting control systems'
        },
        {
        ...
        },
        {
            ...
            'icon': 'fas fa-lock',
            'description': 'Integrated security and access management'
        },
        {
            'title': 'Fire Safety',
            'icon': 'fas fa-fire-extinguisher',
            'description': 'Fire detection and emergency system integration'
        },
        {
    ...
    context = {
        'bms_services': bms_services,
        'partners': partners,
        'bms_features': bms_features,
        'page_title': 'BMS Systems'
    }
    
    return render(request, 'companywebsite/bms_service.html', context)